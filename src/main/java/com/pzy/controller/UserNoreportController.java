 ...
 */
@Controller
@RequestMapping("/admin/usernotreport")
public class UserNoreportController {
	@Autowired
	...
	public String index(Model model) {
		...
		return "admin/usernotreport/index";
	}
	...
	public Map<String, Object> list(
		...
		Page<User> users = userService.findAll(pageNumber, pageSize, username,major);
