					...
					<div class="span12">
						<div class="content-widgets ">
							...
							<div class="control-group" id='control_project'>
								<label for="remark" class="control-label">姓名：</label>
								<div class="controls">
										<input type="text" name="username" value='${sessionScope.adminuser.name}' placeholder="" >
								</div>
							</div>
							<div class="control-group" id='control_project'>
								<label for="num" class="control-label">邮箱：</label>
								<div class="controls">
												<input type="text" name="email" value='${sessionScope.adminuser.email}' placeholder="" >
								</div>
							</div>
							<div class="control-group" id='control_project'>
							...
							<div class="control-group" id='control_project'>
								<label for="tel" class="control-label">职称：</label>
								<div class="controls">
									<input type="text" name="job" id="job" placeholder="" value='${sessionScope.adminuser.job}'>
								</div>
							</div>
