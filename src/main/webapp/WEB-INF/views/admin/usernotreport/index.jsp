...
<head>
<script type="text/javascript" src="${pageContext.request.contextPath}/admin/js/ace/admin.usernotreport.js"></script>
				...
				<div class="row-fluid ">
					<div class="span12">
                  	 ...
                  	 <select name='major.id' id='majorid' class="form-control">
								...
								<a onclick="$.adminUsernotreport.initSearchDataTable()"
