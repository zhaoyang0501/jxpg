...
<head>
<script type="text/javascript" src="${pageContext.request.contextPath}/admin/js/ace/admin.userreportcount.js"></script>
						...
						<div class="content-widgets light-gray">
							...
							<div class="box well form-inline">
								...
								<input type="text" id="_name" >
									<span>专业：</span>
                  	 <select name='major.id' id="majorid" class="form-control">
									<c:forEach items="${majors }" var="bean">
										<option value="${bean.id }">(${bean.school.name }) ${bean.name }</option>
									</c:forEach>
					</select>
					
								<a onclick="$.adminUserreportcount.initSearchDataTable()"
